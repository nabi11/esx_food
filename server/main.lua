...
ESX.RegisterServerCallback('esx_soda:requestDBItems', function(source, cb)
...
RegisterServerEvent('esx_soda:buyItem')
AddEventHandler('esx_soda:buyItem', function(itemName, price)
